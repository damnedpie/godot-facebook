...
signal fb_inited
signal login_success_event(token)
signal login_cancelled_event
signal login_failed_event(error)
signal request_success_event(result)
signal request_cancelled_event
signal request_failed_event(error)
signal logout_event
